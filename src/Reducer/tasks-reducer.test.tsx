import {
    ...
    changeStatusTasksActionCreator,
    removeTasksActionCreator, SetTitleTasksActionCreator,
    tasksReducer
} from "./task-reducer";
...
test('correct task should be added to correct array', () => {
    ...
    const action = addTasksActionCreator("juice", "todolistId2");
...
test('correct tasks status should be changed', () => {
    ...
    const action = changeStatusTasksActionCreator("1", "todolistId1", true);
    const endState = tasksReducer(startState, action);
...
test('correct task title should be changed', ()=>{
    ...
    const action = SetTitleTasksActionCreator("1", "todolistId1", "ddd");
    const endState = tasksReducer(startState, action);
